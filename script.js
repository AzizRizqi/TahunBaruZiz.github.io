...
function toggleMusic() {
    if (music.paused) {
        music.play();
        musicBtn.innerHTML = `<svg fill="white" width="24" height="24"><use href="#icon-pause" xlink:href="#icon-pause"></use></svg>`; // Ganti ikon ke pause
    } else {
        music.pause();
        musicBtn.innerHTML = `<svg fill="white" width="24" height="24"><use href="#icon-play" xlink:href="#icon-play"></use></svg>`; // Ganti ikon ke play
    }
}
